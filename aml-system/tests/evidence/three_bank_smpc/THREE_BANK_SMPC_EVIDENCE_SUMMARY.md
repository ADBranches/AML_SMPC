...
`TX-BANK1-20260428115355`

## Execution Model

`three_bank_smpc_collaboration_demo`
...
- Party count: 3
- Raw bank inputs disclosed: false
- Cross-bank overlap count: 1
- Screening status: screened_watchlist_attention
